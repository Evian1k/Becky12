...
const STORAGE_KEY = "our-forever-bucket-list";
            ...
            <motion.button
              ...
              className={cn(
                ...
                isDone
                  ...
                  : "glass hover:bg-rose-500/5"
              )}
            >
              {/* Glow border when done */}
              {isDone && (
                <motion.div
                  layoutId={`glow-${item.id}`}
                  className="absolute -inset-1 rounded-3xl bg-gradient-to-br from-rose-400 to-pink-400 opacity-30 blur-xl"
                />
              )}
                ...
                <div className="mb-3 flex items-start justify-between">
                  <div
                    className={cn(
                      ...
                      isDone ? "bg-white/20" : "bg-rose-500/10"
                    )}
                  >
                    {item.emoji}
                  </div>
